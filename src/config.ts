...
export const siteConfig: SiteConfig = {
	...
	banner: {
		...
		homeText: {
			...
			title: "a ctfer on the load", // 主页横幅主标题

			subtitle: [
				"Regret is the main theme of life."
			],
			typewriter: {
...
export const profileConfig: ProfileConfig = {
	avatar: "assets/images/zsm.jpg", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "zsm",
	...
	umami: {
		...
		shareId: "0OkyzkJWCbzf3wpL", //填入共享URL最后面那一串  比如：https://eu.umami.is/api/share/2dKQ5T0WrUn6AYtr 你就填入2dKQ5T0WrUn6AYtr
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	dialog: {
		welcome: "Welcome to zsm's blog", // 欢迎词
		touch: [
			"What are you doing?",
			"Stop touching me!",
			"HENTAI!",
