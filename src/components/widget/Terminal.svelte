...
<div class="w-full max-w-[var(--page-width)] mx-auto mb-8 rounded-[var(--radius-large)] overflow-hidden bg-[#1a1b26] border border-black/10 dark:border-white/10 shadow-lg font-mono text-sm" on:click={() => inputElement && inputElement.focus()}>
    <div class="flex items-center justify-between px-4 py-2 bg-[#1f2335] border-b border-black/10 dark:border-white/10">
